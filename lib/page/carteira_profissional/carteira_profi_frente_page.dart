...
void main() => runApp(const CarteiraProfPage());

class CarteiraProfPage extends StatelessWidget {
  const CarteiraProfPage({Key? key}) : super(key: key);
      ...
      child: Scaffold(
        ...
        body: SizedBox(
          ...
          child: ListView(children: [
            ...
            const ButtonPage(
                textButton: 'Continuar', caminho: '/carteiraProverso'),
          ]),
        ),
      ),
    );
